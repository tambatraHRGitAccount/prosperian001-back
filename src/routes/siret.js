...
// GET /siret?q=denominationUniteLegale
router.get('/', async (req, res) => {
  ...
  try {
    ...
    // Appel à l'API SIRENE (endpoint /siret)
    const apiResponse = await axios.get('https://api.insee.fr/entreprises/sirene/V3.11/siret', {
      headers: {
